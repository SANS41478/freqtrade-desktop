        ...
        {sysinfo && (
          <div className="bg-card border border-border rounded-lg p-4 card-glow">
            ...
            <div className="space-y-3">
              ...
              <div>
                <div className="flex items-center justify-between text-xs mb-1">
                  <span className="flex items-center gap-1.5 text-muted-foreground"><HardDrive className="w-3 h-3" /> 内存</span>
              ...
              <div className="pt-2 border-t border-border space-y-1.5 text-xs text-muted-foreground">
                ...
                <div className="flex justify-between"><span>时间框架</span><span className="font-mono text-foreground">{showConfig?.timeframe ?? "-"}</span></div>
                <div className="flex justify-between"><span>交易所</span><span className="font-mono text-foreground">{showConfig?.exchange ?? "-"}</span></div>
                <div className="flex justify-between"><span>运行时长</span><span className="font-mono text-foreground">{uptime}</span></div>
              </div>
            </div>
          </div>
        )}
